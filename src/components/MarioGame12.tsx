...
const MarioGame12: React.FC = () => {
    ...
    useEffect(() => {
        ...
        function create(this: Phaser.Scene) {
            ...
            const chaserWario = this.physics.add.sprite(300, 500, 'wario').setScale(3);
            ...
            const shadowWario = this.physics.add.sprite(100, 500, 'wario').setScale(3);
            ...
            const lungerWario = this.physics.add.sprite(1000, 150, 'wario').setScale(3);
